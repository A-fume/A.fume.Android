package com.scentsnote.scents_note_ui.widget

import android.content.Context
import android.graphics.Typeface
import android.util.AttributeSet
import android.widget.CompoundButton
import com.scentsnote.scents_note_ui.R

class SelectBox @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
    defStyleRes: Int = R.style.ScentsNoteUI_SelectBox_Medium
) : CompoundButton(
    context,
    attrs,
    defStyleAttr,
    ...
    init {
        val defaultBackgroundRes = R.drawable.scents_note_ui_select_box_background
        val defaultBackgroundTintList = null

        val defaultTextColorStateList =
            context.getColorStateList(R.color.scents_note_ui_select_box_text_color)
