        ...
        when(info){
            ...
            "gender" -> {
                if(_isCheckMan.value == true){
                    ScentsNoteApplication.prefManager.userGender = "MAN"
                }else{
                    ScentsNoteApplication.prefManager.userGender = "WOMAN"
                }
            }
            "age" -> {
        ...
        viewModelScope.launch {
            try {
                val registerInfo = RequestRegister(
                    ...
                    ScentsNoteApplication.prefManager.userNickname,
                    ScentsNoteApplication.prefManager.userPassword,
                    ScentsNoteApplication.prefManager.userGender,
                    ScentsNoteApplication.prefManager.userAge
                )
                signRepository.postRegisterInfo(registerInfo).let {
                    ...
                    ScentsNoteApplication.prefManager.userSurvey = true
                }
            } catch (e: HttpException) {
